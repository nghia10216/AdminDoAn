...
class UserController extends Controller
{
    ...
    public function postThem(Request $request)
    {
        $this->validate(
            ...
            [
                ...
                'passwordAgain.required' => 'Bạn chưa nhập lai mạt khẩu',
    ...
    {
        if (Auth::check()) {
            return view('admin.khoa.danhsach');
        } else {
    ...
    public function postDangnhapAdmin(Request $request)
    {
        $this->validate($request, [
            ...
            'password.max' => 'Password không được vượt quá 43 ký tự',
